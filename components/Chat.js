    ...
    <div className="fixed inset-0 bg-white">
      <div className="flex flex-col h-full">
        ...
        <div className="px-4 py-3 border-b flex items-center justify-between">
          <div className="font-bold text-xl">Our chat</div>
          <div className="w-32 h-10 bg-sky-800 rounded-tl-2xl rounded-bl-2xl flex items-center justify-center border-l-2 text-white">
            Deep chat AI
          </div>
        </div>
